...
<html lang="pt-br">
    ...
    <body>
        ...
        <header>
           <center><img src="imagens/logo_loja.png" width="50%" height="50%"/></center> 
            <nav class="navbar navbar-expand-lg navbar-ligth bg-ligth">
                <div class="container-fluid">
                    <h3><b>Cadastro de convidados</b></h3>
        ...
        <footer>
            <hr/>
            <center><b>Cadastro de clientes - Desenvolvildo pelo aluno Leonildo Muniz turma TDS06</b></center>
        </footer>
    </body>
</html>