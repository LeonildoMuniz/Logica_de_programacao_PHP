                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-hearder py-3">
                                <h4 class="my-0 fw-normal"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
                                ...
                                </svg>&nbsp;<b>Editar Produtos</b></h4>
                            </div>
                            <div class="card-body">
                            <form action="edita.php?posicao=<?php echo $posicao;?>" method="POST">
                                    <div class="form-group">
                                        <label>Código</label>
                                        <input type="number" class="form-control" name="codigo" value="<?php echo $produto[$posicao];?>" required/>
                                        <br/>
                                        <label>Descrição</label>
                                        <input type="text" class="form-control" name="descricao" value="<?php echo $produto[$posicao+1];?>" required/>
                                        <br/>
                                        <label>Ingredientes</label>
                                        <input type="text" class="form-control" name="ingredientes" value="<?php echo $produto[$posicao+2];?>" required/>
                                        <br/>
                                        <label>Preço</label>
                                        <input type="number" class="form-control" name="preco" value="<?php echo $produto[$posicao+3];?>" required name="price" min="0" value="0" step="any"/>
                                        <br/>
