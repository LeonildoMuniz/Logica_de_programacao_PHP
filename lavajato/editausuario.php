...
<html lang="pt-br">
    <head>
        ...
        <title>Lava Jato Express</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    </head>
    <body>
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
        <header>
        <center><img src="imagens/lava_jato.png" width="50%" height="50%"/></center>
                        ...
                        <div class="card mb-2 rounded-2 shadow-sm">
                            ...
                            <form action="editarusuario.php?id=<?php echo $id; ?>" method="POST">
                                <div class="form-group col-7">
                                    ...
                                    <button type="submit" class="btn btn-outline-success">Atualizar Usuario</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-outline-primary" href="index.php" role="button">Voltar</a>
                                </form>
                                </div>
                            </div>
                        </div>
        ...
        <footer>
            <hr/>
            <center><b>Controle Lava Jato - Desenvolvido pelo aluno Leonildo Muniz - 2021</b></center>
        </footer>
    </body>
</html>